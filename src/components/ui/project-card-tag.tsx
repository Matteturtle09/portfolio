...
const ProjectCardTag = ({ tag }: ProjectCardTagProps) => {
  ...
  return (
    <div className="group flex cursor-pointer items-center gap-2">
      ...
      <span className="max-w-0 overflow-hidden font-mono text-xs whitespace-nowrap opacity-0 transition-all duration-300 ease-out group-hover:max-w-[100px] group-hover:opacity-100">
        {tag}
      </span>
    </div>
  )
